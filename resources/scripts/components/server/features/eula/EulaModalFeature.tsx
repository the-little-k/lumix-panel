    ...
    return (
        ...
        >
            ...
            <p css={tw`mt-3 text-sm leading-relaxed text-lumix-muted`}>
                ...
                <a
                    target={'_blank'}
                    css={tw`font-medium text-indigo-300 underline decoration-indigo-400/40 underline-offset-2 transition-colors hover:text-indigo-200`}
            ...
            <div css={tw`mt-8 flex flex-col-reverse gap-3 sm:flex-row sm:justify-end`}>
                ...
                <Button onClick={onAcceptEULA} css={tw`w-full sm:w-auto`}>
                    I Accept
                </Button>
            </div>
        </Modal>
