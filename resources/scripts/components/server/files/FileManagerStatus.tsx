        ...
        <div className={'space-y-2 mt-6'}>
            {uploads.map(([name, file]) => (
                <div
                    key={name}
                    className={
                        'flex items-center space-x-3 rounded-xl border border-lumix-border/40 bg-black/25 p-3 backdrop-blur-sm'
                    }
                >
                    ...
                    <button
                        ...
                        className={'text-lumix-muted transition-colors duration-75 hover:text-[var(--lumix-text)]'}
                    >
